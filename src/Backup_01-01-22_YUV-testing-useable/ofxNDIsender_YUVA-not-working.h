...
private:
	...
	// Read YUV pixels from fbo to pixel buffer
	bool ReadYUVpixels(ofFbo fbo, unsigned int width, unsigned int height, ofPixels &buffer);

	// Read YUVA pixels from texture to pixel buffer
	bool ReadYUVApixels(ofFbo fbo, unsigned int width, unsigned int height, ofPixels &buffer);

	// Read YUV pixels from texture to pixel buffer
	bool ReadYUVpixels(ofTexture tex, unsigned int width, unsigned int height, ofPixels &buffer);

	// Read YUVA pixels from texture to pixel buffer
	bool ReadYUVApixels(ofTexture tex, unsigned int width, unsigned int height, ofPixels &buffer);
