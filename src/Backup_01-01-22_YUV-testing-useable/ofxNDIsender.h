...
public:
	...
	// Read pixels from RGBA fbo to pixel buffer
	// LJ DEBUG
...
private:
	...
	ofShader rgba2yuv;  // Shader for RGBA to YUV conversion
	ofShader rgba2yuva; // Shader for RGBA to YUVA conversion
	ofShader rgba2bgra; // Shader for RGBA to BGRA conversion
	...
	bool ReadYUVpixels(ofFbo fbo, unsigned int width, unsigned int height, ofPixels &buffer);

	// Read YUV pixels from RGBA texture to pixel buffer
	bool ReadYUVpixels(ofTexture tex, unsigned int width, unsigned int height, ofPixels &buffer);

	// LJ DEBUG
	// Read BGRA pixels from RGBA fbo to pixel buffer
	bool ReadBGRApixels(ofFbo fbo, unsigned int width, unsigned int height, ofPixels &buffer);
	// Read BGRA pixels from RGBA texture to pixel buffer
	bool ReadBGRApixels(ofTexture tex, unsigned int width, unsigned int height, ofPixels &buffer);
