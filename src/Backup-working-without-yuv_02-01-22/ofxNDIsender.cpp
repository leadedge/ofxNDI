/*
	...
	02/01/21 - Pass by reference for ofFbo, ofTexture and ofImage
...
bool ofxNDIsender::SendImage(ofTexture &tex, bool bInvert)
{
	...
	ofDisableDepthTest(); // In case it was enabled, or textures do not show
	...
	bool bSwapRB, bool bInvert)
{
	...
	// NDI format must be set to RGBA
