...
void ofApp::setup()
{
	...
	// TODO - to be tested
	// If audio is priority, clock to audio for the NDI sender 
	// ndiSender.SetClockAudio(true);
	// If sync of audio to graphics is priority, clock to the video
...
void ofApp::DrawAudio()
{
	...
	//
	// Planar audio (default audio type is audio_frame_v2_t)
	//
	if (ndiSender.GetAudioType() == audio_frame_v2_t) {
